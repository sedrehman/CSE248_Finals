...
public class AddItemController implements Initializable {
	...
	void addButtonClicked(ActionEvent event) {
		if (!name.getText().equals(null) || !name.getText().equals("") || !price.getText().equals(null)
				|| !price.getText().equals("") || !stackLocation.getText().equals(null)
				|| !stackLocation.getText().equals("") || !quantity.getText().equals(null)
			...
			if(!decimal.getText().equals("") || !decimal.getText().equals(null)) {
				thePrice += Double.parseDouble(decimal.getText());
			}
			si.saveTheItems(name.getText(), thePrice, stackLocation.getText(),
